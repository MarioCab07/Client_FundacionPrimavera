      ...
      >
        ...
        >
          <div className="flex flex-col gap-6 p-10 flex-1">
            ...
            <label htmlFor="adress" className="text-lg flex flex-col">
          ...
          <div className="flex flex-col gap-6 p-10 flex-1">
            <label htmlFor="" className="text-lg gap-2 flex flex-col">
              ...
              <BasicSelect
                ...
                options={["Horas Sociales", "Voluntario", "Otro"]}
                value={form.service_type}
                setValue={(value) => setForm({ ...form, service_type: value })}
              />
            </label>
            ...
            <label htmlFor="year_studied" className="text-lg flex flex-col">
        ...
        <div className="py-8 absolute -bottom-14">
          <button
            type="submit"
