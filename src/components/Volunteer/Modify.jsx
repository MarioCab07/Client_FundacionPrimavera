...
const Modify = ({vol,setShowModify,setVolSelected}) => {
    const inputStyle = `
...
const handleClose = () => {
  ...
  >
    ...
    <div className="w-full flex justify-center items-center gap-6 flex-wrap">
        ...
        <h4>
            Fecha de Nacimiento: <span className="font-semibold">{sanitizeDate(modifiedVol.birth_date)}</span>
        </h4>
        <h4>
            Fecha de Inicio: <span className="font-semibold">{ sanitizeDate(modifiedVol.starting_date)}</span>
        </h4>
    ...
    <div className="flex gap-5 justify-center h-max items-start flex-wrap">
        ...
        <h5 className="font-bold">Información de Contacto</h5>
            ...
            onChange={(e) => handlePhoneChange(e, setModifiedVol, modifiedVol)}
        ...
        <div className="flex flex-col gap-2 justify-center items-center h-max  flex-1">
            ...
            onChange={(e)=>{handleNumbers(e,setModifiedVol,modifiedVol)}}
