...
const Deactive = ({ vol, setShowDeactive, fetchData }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const toastId = toast.loading("Desactivando Voluntario...");
    try {
      await sleep(800);
      ...
      >
        ...
        >
          <label htmlFor="confirm">
            <p className="text-center text-gray-700">
              Para confirmar la desactivacion, escribe "confirmar"
            </p>
            <input
              type="text"
              id="confirm"
          ...
          <div className="flex justify-between items-center gap-4 w-full">
            <button
              ...
              type="submit"
            >
              Confirmar <AiOutlineDelete size={20} />
            </button>
            <button
